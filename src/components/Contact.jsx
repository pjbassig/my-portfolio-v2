export function Contact() {
  return (
    <section id="contact" className="max-w-5xl mx-auto px-6 py-24 border-t border-white/5">
      ...
      <a href="mailto:you@email.com" className="text-accent text-xl font-mono hover:underline">
  ...
  return (
    <footer className="max-w-5xl mx-auto px-6 py-10 text-muted text-sm flex justify-between border-t border-white/5">
      ...
      <div className="flex gap-4">
        <a href="https://github.com/pjbassig" className="hover:text-text">GitHub</a>
        <a href="https://www.linkedin.com/in/paul-joshua-bassig-47a5ab1b9/" className="hover:text-text">LinkedIn</a>
      </div>
    </footer>
  );
}